...
public class VKWorker {
    ...
    private static final String groupId = "120338153";
    ...
    public static Product addProduct(Product product){
        ...
        System.out.print("Adding product to VK group... ");
        ...
        HttpEntity httpEntity = MultipartEntityBuilder.create()
                ...
                .addTextBody("price", String.valueOf(product.getPrice().multiply(priceMultiplyer)))
        ...
        if (response != null && response.contains("market_item_id")) {
            ...
            // Обновляем продукт в БД - добавляем VkID и VkPhotoId
//            DBWorker.updateProduct(product);
    ...
    public static boolean updateProduct(Product product){
        ...
        System.out.println("Updating product \"" + product.getName() + "\" in VK group:");
